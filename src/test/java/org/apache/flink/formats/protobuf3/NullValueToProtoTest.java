...
import org.apache.flink.formats.protobuf3.testproto.NullTest;
import org.apache.flink.table.data.*;
import org.apache.flink.table.types.logical.RowType;
import org.junit.jupiter.api.Test;

import static org.apache.flink.formats.protobuf3.ProtobufTestHelper.mapOf;
    ...
    public void testSimple() throws Exception {
        RowData row =
                GenericRowData.of(
                        ...
                        new GenericArrayData(new Object[]{null}));
        RowType rowType = PbToRowTypeUtil.generateRowType(NullTest.getDescriptor());
        ...
        assertEquals(NullTest.InnerMessageTest.getDefaultInstance(),
