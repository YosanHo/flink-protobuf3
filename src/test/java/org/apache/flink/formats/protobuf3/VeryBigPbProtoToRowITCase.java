...
import org.apache.flink.formats.protobuf3.testproto.VeryBigPbClass;
...
public class VeryBigPbProtoToRowITCase {
    ...
    public void testSimple() throws Exception {
        ...
        RowType rowType = PbToRowTypeUtil.generateRowType(VeryBigPbClass.VeryBigPbMessage.getDescriptor());
        RowData rowData = ProtobufTestHelper.pbBytesToRow(veryBigPbMessage.toByteArray(), rowType);
    }
}
