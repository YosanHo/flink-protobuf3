...
import org.apache.flink.formats.protobuf3.testproto.BigPbClass;
...
public class BigPbRowToProtoTest {
    ...
    public void testSimple() throws Exception {
        ...
        byte[] bytes = ProtobufTestHelper.rowToPbBytes(rowData, PbToRowTypeUtil.generateRowType(BigPbClass.BigPbMessage.getDescriptor()));
