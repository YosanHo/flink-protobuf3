...
import org.apache.flink.formats.protobuf3.testproto.RepeatedMessageTest;
...
public class RepeatedMessageProtoToRowTest {
    ...
    public void testRepeatedMessage() throws Exception {
        ...
        RowData row = ProtobufTestHelper.pbBytesToRow(repeatedMessageTest.toByteArray(), rowType);
