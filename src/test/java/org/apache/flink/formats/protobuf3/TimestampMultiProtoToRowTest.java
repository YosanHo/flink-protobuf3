...
import org.apache.flink.formats.protobuf3.testproto.TimestampTestMulti;
...
public class TimestampMultiProtoToRowTest {
    ...
    public void testSimple() throws Exception {
        ...
        RowType rowType = PbToRowTypeUtil.generateRowType(TimestampTestMulti.getDescriptor());
        RowData row = ProtobufTestHelper.pbBytesToRow(timestampTestMulti.toByteArray(), rowType);
